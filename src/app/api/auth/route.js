...
// // ⚠️ DEPRECATED: Este arquivo não é mais usado após migração para Supabase Auth
// // A autenticação agora é feita via supabase.auth.signInWithPassword(), signUp(), etc.
// // Mantido apenas para referência histórica ou migração incremental
// // Para novo código, use os métodos do hook useAuth.js que integra com Supabase Auth
